...
def setup_test_db():
    database = r"../databases/test_data.db"
    ...
    with conn:
        ...
        load_csv_into_sql_table(conn, '../data/SP500_Test_Small_Time_1.0.csv', table_name=table_name, dtype=data_types, cleaning_function=_time_data_cleaning)
        # load_csv_into_sql_table(conn, '../data/SP500_Test_Small_Time_1.0.csv', table_name=table_name, dtype=data_types)
